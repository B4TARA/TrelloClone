...
{
    public class CardLayoutViewComponent : ViewComponent
    {
        private readonly RepositoryManager _repository;
        public CardLayoutViewComponent(RepositoryManager repository)
        {
